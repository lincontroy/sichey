...
<head>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="assets/css/t.css"> -->
...
<body>
    <div class="page_wrapper">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-5">
                            <div class="site_logo"><a class="site_link" href="/"><img class="dark_theme_logo"
                                        ...
                                        alt="Site Logo – ProMotors – Car Service & Detailing Template"> <img
                                        class="light_theme_logo" src="assets/images/site_logo/sichey.png"
                            ...
                            <nav class="main_menu navbar navbar-expand-lg">
                                <div class="main_menu_inner collapse navbar-collapse justify-content-center"
                                    ...
                                    <ul class="main_menu_list unordered_list_center">
                                        <li><a class="nav-link" href="/" id="home_submenu">Home</a>

                                        </li>
                                        <li><a class="nav-link" href="/about">About</a>

                                        </li>
                                        <li><a class="nav-link" href="/service">Service center</a>

                                        </li>
                                        <li><a class="nav-link" href="/spares">Spares</a>

                                        </li>
                                        <li><a class="nav-link" href="/gallery">Gallery</a>

                                        </li>

                                        <li><a class="nav-link" href="/tractors">Tractors</a>
                        ...
                        <div class="col-lg-3 col-5">
                            <ul class="header_btns_group unordered_list_end">
                                <li><button class="mobile_menu_btn" type="button" data-bs-toggle="collapse"
                                        ...
                                        aria-label="Toggle navigation"><i class="far fa-bars"></i></button></li>
                                <li>
                                    <div class="mode-switch" data-bs-toggle="mode" data-cursor="-opaque" data-magnetic>
                                        <input id="theme-mode-btn" type="checkbox"></div>
                                </li>
                                <li><a class="btn_hotline" href="/contact"><span class="btn_text">Contact us</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <footer class="site_footer">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="footer_about pe-lg-5">
                                <div class="site_logo"><a class="site_link" href="index.html"><img
                                            ...
                                            alt="Site Logo – ProMotors – Car Service & Detailing Template"></a></div>
                                <h3>Mission</h3>
                                <p>To always offer our customers solutions with their business needs in mind. Unwavering
                                    spirit and
                                    commitment to evoking
                                    smiles in our customers
                                    when we engage is what
                                    drives us.</p>
                                <h3>Vision</h3>
                                <p>To be the most effective and efficient
                                    business partner to our customers and
                                    stakeholders</p>
                        ...
                        <div class="col-lg-2 col-md-6 col-sm-6">
                            <div class="info_list_wrap">
                                ...
                                <ul class="info_list unordered_list_block text-uppercase">
                                    <li><a href=""><span class="info_icon"><img
                                                    src="assets/images/icons/icon_square.svg"
                                                    alt="ProMotors - Icon Square"> </span><span class="info_text">We are
                                                an automotive company specializing in offering customized mobility
                                                solutions to address unique customer needs. Unwavering spirit and
                                                commitment to evoking smiles in our customers when we engage is what
                                                drives us.</span></a></li>
            ...
            <a href="https://wa.me/254735500500" target="_blank" class="whatsapp-icon">
